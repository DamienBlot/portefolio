        ...
        <div className="grid grid-cols-2 gap-8 justify-items-center mb-10">
          ...
          <div className="max-w-sm rounded overflow-hidden shadow-lg  grid grid-cols-1 bg-white">
            ...
            <div className="px-6 py-4">
                ...
                Double star ranger in Salesforce.
                </p>
            </div>
            <Link href="/studies/trailhead" className="w-32 inline-flex items-center ml-5 mb-5 px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            More details
          ...
          <Card src="/logo-etna.png" alt="logo-etna" width="200" height="50" cssClass="bg-white justify-self-center my-10 p-5 border-2 border-black" titleName="ETNA" cardText="Licence degree in 1 year with apprenticeship" hrefLink="/studies/licence"/>
        </div>
    )};