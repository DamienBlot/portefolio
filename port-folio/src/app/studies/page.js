    ...
    return (
        <div className="grid grid-cols-2 gap-8 justify-items-center mb-10">
          ...
          <div className="max-w-sm rounded overflow-hidden shadow-lg  grid grid-cols-1 bg-white">
            ...
            <Link href="/" className="w-32 inline-flex items-center ml-5 mb-5 px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            More details
